...
require (
	...
	github.com/kcp-dev/kcp/pkg/apis v0.10.1-0.20230209174850-880576a7d082
...
replace sigs.k8s.io/controller-runtime v0.12.3 => github.com/kcp-dev/controller-runtime v0.12.2-0.20230210133534-6a34cae9a543
